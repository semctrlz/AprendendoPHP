...
<li><label for="signup"><i class="fa fa-credit-card"></i> CADASTRAR</label></li>
</ul>
</div>
...
<ul class="ul-list">
<li><input type="text" required class="input" placeholder="Usuario" name="login_nome"/><span class="icon"><i class="fa fa-user"></i></span></li>
<li><input type="password" required class="input" placeholder="Senha" name="login_senha"/><span class="icon"><i class="fa fa-lock"></i></span></li>
<li><span class="remember"><input type="checkbox" id="check" name="lembrar"> <label for="check" >Continuar conectado</label></span><span class="remember"><a href="">Me esquecer</a></span></li>
...
<form action="" method="post">
<ul class="ul-list">
    <li><input type="text" required class="input" placeholder="Nome" name="nome"/><span class="icon"><i class="fa fa-user"></i></span></li>
    <li><input type="text" required class="input" placeholder="Usuario" name="login"/><span class="icon"><i class="fa fa-user"></i></span></li>
<li><input type="email" required class="input" placeholder="Email" name="email"/><span class="icon"><i class="fa fa-user"></i></span></li>
<li><input type="password" required class="input" placeholder="Senha" id="password" name="senha"/><span class="icon"><i class="fa fa-lock"></i></span></li>
<li><input type="password" required class="input" placeholder="Repetir senha" id = "confirm_password"/><span class="icon"><i class="fa fa-lock"></i></span></li>
<li><input type="checkbox" id="check1" required> <label for="check1">Eu aceito os <a href="#" target="_blank">termos e condi&ccedil;&otilde;es de uso</a></label></li>
...
function validatePassword(){
  if(password.value != confirm_password.value) {
    confirm_password.setCustomValidity("Senhas devem ser iguais");
  } else {
